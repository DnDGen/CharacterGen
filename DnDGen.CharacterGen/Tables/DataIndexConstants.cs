namespace DnDGen.CharacterGen.Tables
{
    internal static class DataIndexConstants
    {
        internal static class CharacterClassFeatData
        {
            ...
            public const int FrequencyQuantityStatIndex = 7;
            public const int SizeRequirementIndex = 8;
            public const int AllowFocusOfAllIndex = 9;
        }

        internal static class RacialFeatData
        {
            public const int FeatNameIndex = 0;
