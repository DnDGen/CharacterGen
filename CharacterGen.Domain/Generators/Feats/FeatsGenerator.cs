...
namespace CharacterGen.Domain.Generators.Feats
{
    internal class FeatsGenerator : IFeatsGenerator
    {
        ...
        {
            var racialFeats = racialFeatsGenerator.GenerateWith(race, skills, abilities);
            var classFeats = classFeatsGenerator.GenerateWith(characterClass, race, abilities, racialFeats, skills);
            var automaticFeats = racialFeats.Union(classFeats);
            var additionalFeats = additionalFeatsGenerator.GenerateWith(characterClass, race, abilities, skills, baseAttack, automaticFeats);
