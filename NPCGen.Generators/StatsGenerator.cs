...
namespace NPCGen.Generators
{
    ...
    {
        private IDice dice;
        private IStatPrioritySelector statPriorityProvider;
        private IStatAdjustmentsSelector statAdjustmentsProvider;

        public StatsGenerator(IDice dice, IStatPrioritySelector statPriorityProvider, IStatAdjustmentsSelector statAdjustmentsProvider)
        {
            this.dice = dice;
