...
namespace NPCGen.Generators
{
    ...
    {
        private ILanguageGenerator languageFactory;
        private IAlignmentGenerator alignmentFactory;
        private ICharacterClassGenerator characterClassFactory;
        private IStatsGenerator statsFactory;
        private IHitPointsGenerator hitPointsFactory;
        private IRaceGenerator raceFactory;
        ...
        public CharacterGenerator(IAlignmentGenerator alignmentFactory, ICharacterClassGenerator characterClassFactory, IRaceGenerator raceFactory, IStatsGenerator statsFactory, ILanguageGenerator languageFactory, IHitPointsGenerator hitPointsFactory, ILevelAdjustmentsSelector levelAdjustmentsProvider, IRandomizerVerifier randomizerVerifier, IPercentileSelector percentileResultProvider)
        {
