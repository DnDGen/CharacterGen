...
namespace CharacterGen.Tests.Integration.Tables.Races.BaseRaces.Heights
{
    ...
    [TestFixture]
    public class HillDwarfHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEHeights, RaceConstants.BaseRaces.HillDwarf); }
        }
