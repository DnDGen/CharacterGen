...
{
    [TestFixture]
    public class MaleTallfellowHalflingHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.GENDERRACEHeights, "Male", RaceConstants.BaseRaces.TallfellowHalfling); }
        }
