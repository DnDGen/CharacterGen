...
{
    [TestFixture]
    public class MaleDeepDwarfHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.GENDERRACEHeights, "Male", RaceConstants.BaseRaces.DeepDwarf); }
        }
        ...
        [TestCase(AdjustmentConstants.Base, 45)]
