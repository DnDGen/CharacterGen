...
{
    [TestFixture]
    public class HalfElfHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEHeights, RaceConstants.BaseRaces.HalfElf); }
        }
        ...
        [TestCase(AdjustmentConstants.Base + TrueString, 55)]
