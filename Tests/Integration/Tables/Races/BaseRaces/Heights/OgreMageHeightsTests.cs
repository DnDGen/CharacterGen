...
{
    [TestFixture]
    public class OgreMageHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEHeights, RaceConstants.BaseRaces.OgreMage); }
        }
        ...
        [TestCase(AdjustmentConstants.Base + TrueString, 108)]
