...
{
    [TestFixture]
    public class HobgoblinHeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEHeights, RaceConstants.BaseRaces.Hobgoblin); }
        }
        ...
        [TestCase(AdjustmentConstants.Base + FalseString, 48)]
        [TestCase(AdjustmentConstants.Base + TrueString, 50)]
