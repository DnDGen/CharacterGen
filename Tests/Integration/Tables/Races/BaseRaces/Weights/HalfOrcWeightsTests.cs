...
{
    [TestFixture]
    public class HalfOrcWeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEWeights, RaceConstants.BaseRaces.HalfOrc); }
        }
        ...
        [TestCase(AdjustmentConstants.Base + FalseString, 110)]
