...
{
    [TestFixture]
    public class FemaleHalfOrcWeightsTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.GENDERRACEWeights, "Female", RaceConstants.BaseRaces.HalfOrc); }
        }
        ...
        [TestCase(AdjustmentConstants.Base, 110)]
