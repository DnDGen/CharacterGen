...
{
    [TestFixture]
    public class TrainedBugbearAgesTests : AdjustmentsTests
    {
        protected override String tableName
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.AGEGROUPRACEAges, GroupConstants.Trained, RaceConstants.BaseRaces.Bugbear); }
        }
        ...
        [TestCase(AdjustmentConstants.Adulthood, 11)]
