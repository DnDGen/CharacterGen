...
namespace CharacterGen.Tests.Integration.Tables.Races.BaseRaces.Ages
{
    ...
    public class HalfElfAgesTests : AdjustmentsTests
    {
        ...
        {
            get { return String.Format(TableNameConstants.Formattable.Adjustments.RACEAges, RaceConstants.BaseRaces.HalfElf); }
        }
        ...
        [TestCase(AdjustmentConstants.Quantity + GroupConstants.SelfTaught, 2)]
        [TestCase(AdjustmentConstants.Die + GroupConstants.SelfTaught, 6)]
        [TestCase(AdjustmentConstants.Quantity + GroupConstants.Trained, 3)]
