...
{
    [TestFixture]
    public class AnimalBaseRaceRandomizerTests : StressTests
    {
        [Inject, Named(RaceRandomizerTypeConstants.BaseRace.AnimalBase)]
        public RaceRandomizer AnimalBaseRaceRandomizer { get; set; }
        ...
        private IEnumerable<String> animals;
        ...
        protected override void MakeAssertions()
        {
            ...
            var animalBaseRace = AnimalBaseRaceRandomizer.Randomize(alignment, characterClass);
            Assert.That(animals, Contains.Item(animalBaseRace));
        }
    }
}
