...
{
    [TestFixture]
    public class NeutralMetaraceRandomizerTests : DurationTest
    {
        [Inject]
        ...
        [Test]
        public void NeutralMetaraceRandomizationWithEmptyAllowed()
        {
        ...
        [Test]
        public void NeutralMetaraceRandomizationWithEmptyNotAllowed()
        {
