...
{
    [TestFixture]
    public class NonNeutralMetaraceRandomizerTests : DurationTest
    {
        [Inject]
        ...
        [Test]
        public void NonNeutralMetaraceRandomizationWithEmptyAllowed()
        {
        ...
        [Test]
        public void NonNeutralMetaraceRandomizationWithEmptyNotAllowed()
        {
