...
namespace NPCGen.Tests.Unit.Common.Abilities.Feats
{
    ...
    public class FeatConstantsTests
    {
        ...
        [TestCase(FeatConstants.LightBlindnessId, "LightBlindness")]
        [TestCase(FeatConstants.ArmorBonusId, "ArmorBonus")]
        [TestCase(FeatConstants.FlurryOfBlowsId, "FlurryOfBlows")]
        [TestCase(FeatConstants.MonkUnarmedStrikeId, "MonkUnarmedStrike")]
        [TestCase(FeatConstants.StillMindId, "StillMind")]
        [TestCase(FeatConstants.KiStrikeId, "KiStrike")]
        [TestCase(FeatConstants.SlowFallId, "SlowFall")]
        [TestCase(FeatConstants.PurityOfBodyId, "PurityOfBody")]
        [TestCase(FeatConstants.WholenessOfBodyId, "WholenessOfBody")]
        [TestCase(FeatConstants.DiamondBodyId, "DiamondBody")]
        [TestCase(FeatConstants.AbundantStepId, "AbundantStep")]
        [TestCase(FeatConstants.DiamondSoulId, "DiamondSoul")]
        [TestCase(FeatConstants.QuiveringPalmId, "QuiveringPalm")]
        [TestCase(FeatConstants.TimelessBodyId, "TimelessBody")]
