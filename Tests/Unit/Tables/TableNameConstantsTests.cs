...
namespace NPCGen.Tests.Unit.Tables
{
    ...
    public class TableNameConstantsTests
    {
        ...
        [TestCase(TableNameConstants.Set.Collection.RacialFeatBaseRaceRequirements, "RacialFeatBaseRaceRequirements")]
        [TestCase(TableNameConstants.Set.Collection.RacialFeatHitDieRequirements, "RacialFeatHitDieRequirements")]
        [TestCase(TableNameConstants.Set.Collection.RacialFeatMetaraceRequirements, "RacialFeatMetaraceRequirements")]
        [TestCase(TableNameConstants.Set.Collection.RacialFeatMetaraceSpeciesRequirements, "RacialFeatMetaraceSpeciesRequirements")]
        ...
        [TestCase(TableNameConstants.Set.Collection.Groups.Racial, "Racial")]
