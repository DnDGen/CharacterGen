...
namespace NPCGen.Tests.Unit.Generators.Abilities
{
    ...
    public class AbilitiesGeneratorTests
    {
        ...
        public void AdjustSkillsByFeat()
        {
            ...
            var tableName = String.Format(TableNameConstants.Formattable.Collection.FEATSkillAdjustments, feats[0].Name);
            ...
            tableName = String.Format(TableNameConstants.Formattable.Collection.FEATSkillAdjustments, feats[1].Name);
