...
namespace NPCGen.Tests.Unit.Generators.Abilities.Feats
{
    ...
    {
        private IAdditionalFeatsGenerator additionalFatsGenerator;
        ...
        public void Setup()
        {
            ...
            additionalFatsGenerator = new AdditionalFeatsGenerator(mockCollectionsSelector.Object, mockAdjustmentsSelector.Object, mockFeatsSelector.Object, mockDice.Object, mockNameSelector.Object);
        ...
        public void GetBaseRacialFeats()
        {
            ...
            var feats = additionalFatsGenerator.GenerateWith(characterClass, race, stats, skills, baseAttack);
