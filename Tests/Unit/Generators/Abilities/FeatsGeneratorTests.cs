...
namespace NPCGen.Tests.Unit.Generators.Abilities
{
    ...
    public class FeatsGeneratorTests
    {
        ...
        public void GetMonsterHitDiceForRequirements()
        {
            ...
            race.BaseRace = "base race";
            mockCollectionsSelector.Setup(s => s.SelectFrom("BaseRaceGroups", "Monsters")).Returns(new[] { race.BaseRace });
        ...
        public void NonMonstersHaveOneMonsterHitDieForSakeOfHitDiceRequirements()
        {
            ...
            race.BaseRace = "base race";
            mockCollectionsSelector.Setup(s => s.SelectFrom("BaseRaceGroups", "Monsters")).Returns(new[] { "other base race" });
        ...
        public void SpellcastersCanSelectRayForSpecificApplications()
        {
            ...
            mockCollectionsSelector.Setup(s => s.SelectFrom("FeatSpecificApplications", AdditionalFeatSelectionConstants.WeaponsWithUnarmedAndGrappleAndRay))
                .Returns(weapons);
