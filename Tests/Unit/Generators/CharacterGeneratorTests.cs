...
namespace CharacterGen.Tests.Unit.Generators
{
    ...
    public class CharacterGeneratorTests
    {
        ...
        public void CohortIsGeneratedIndependently()
        {
            ...
            mockMagicGenerator.Setup(g => g.GenerateWith(cohortAlignment, cohortClass, cohortRace, cohortAbility.Stats, cohortAbility.Feats, cohortEquipment)).Returns(cohortMagic);
        ...
        [Test]
        public void AnimalsDecreaseScoreOfAttractingCohorts()
        {
            feats.Add(new Feat());
            feats[0].Name = FeatConstants.Leadership;
        ...
        public void FollowersGeneratedIndependently()
        {
            ...
            while (followerAlignments.Count < 12)
            {
                ...
                mockMagicGenerator.Setup(g => g.GenerateWith(followerAlignment, followerClass, followerRace, followerAbility.Stats, followerAbility.Feats, followerEquipment))
