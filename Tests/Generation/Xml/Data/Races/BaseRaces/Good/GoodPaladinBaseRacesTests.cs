...
namespace NPCGen.Tests.Generation.Xml.Data.Races.BaseRaces.Good
{
    ...
    public class GoodPaladinBaseRacesTests : PercentileTests
    {
        ...
        {
            AssertContentIsInRange(RaceConstants.BaseRaces.Aasimar, 1, 10);
        }

        [Test]
        public void GoodPaladinHillDwarfPercentile()
        {
            AssertContentIsInRange(RaceConstants.BaseRaces.HillDwarf, 11, 20);
        }

        [Test]
        public void GoodPaladinMountainDwarfPercentile()
        {
            AssertContentOnSingleRoll(RaceConstants.BaseRaces.MountainDwarf, 21);
        }

        [Test]
        public void GoodPaladinRockGnomeDwarfPercentile()
        {
            AssertContentOnSingleRoll(RaceConstants.BaseRaces.RockGnome, 22);
        }

        [Test]
        public void GoodPaladinHalfElfPercentile()
        {
            AssertContentIsInRange(RaceConstants.BaseRaces.HalfElf, 23, 27);
        }

        [Test]
        public void GoodPaladinLightfootHalflingPercentile()
        {
            AssertContentOnSingleRoll(RaceConstants.BaseRaces.LightfootHalfling, 28);
        }

        [Test]
        public void GoodPaladinDeepHalflingPercentile()
        {
            AssertContentOnSingleRoll(RaceConstants.BaseRaces.DeepHalfling, 29);
        }

        [Test]
        public void GoodPaladinHalfOrcPercentile()
        {
            AssertContentOnSingleRoll(RaceConstants.BaseRaces.HalfOrc, 30);
        }

        [Test]
        public void GoodPaladinHumanPercentile()
        {
            AssertContentIsInRange(RaceConstants.BaseRaces.Human, 31, 97);
        }
