...
namespace NPCGen.Tests.Generation.Verifiers.Alignments
{
    ...
    public class LawfulAlignmentVerifierTests : AlignmentVerifierTests
    {
        ...
        {
            AssertClassNameIsNotAllowed(CharacterClassConstants.Barbarian);
        }

        [Test]
        public void BardIsNotAllowed()
        {
            AssertClassNameIsNotAllowed(CharacterClassConstants.Bard);
        }
        ...
        {
            AssertClassNameIsAllowed(CharacterClassConstants.Paladin);
        }
