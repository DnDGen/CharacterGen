...
{
    [TestFixture]
    public class ConstitutionAbilityAdjustmentsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.ABILITYAbilityAdjustments, AbilityConstants.Constitution); }
        }
        ...
        [TestCase(RaceConstants.BaseRaces.Kapoacinth, 8)]
        ...
        public void ConstitutionAbilityAdjustment(string name, int adjustment)
        {
