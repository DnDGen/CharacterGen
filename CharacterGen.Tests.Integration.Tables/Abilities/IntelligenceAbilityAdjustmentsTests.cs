...
{
    [TestFixture]
    public class IntelligenceAbilityAdjustmentsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.ABILITYAbilityAdjustments, AbilityConstants.Intelligence); }
        }
        ...
        [TestCase(RaceConstants.BaseRaces.StormGiant, 6)]
        ...
        public void IntelligenceAbilityAdjustment(string name, int adjustment)
        {
