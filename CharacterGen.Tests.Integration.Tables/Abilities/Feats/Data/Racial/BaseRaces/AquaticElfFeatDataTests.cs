...
{
    [TestFixture]
    public class AquaticElfFeatDataTests : RacialFeatDataTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Collection.RACEFeatData, RaceConstants.BaseRaces.AquaticElf); }
        }
        ...
        public override void CollectionNames()
        {
            var names = new[]
            {
                ...
                FeatConstants.SuperiorLowLightVision,
                FeatConstants.Gills,
        ...
        [TestCase(FeatConstants.ImmuneToEffect,
            ...
            0,
            0, 0)]
        [TestCase(FeatConstants.SuperiorLowLightVision,
            FeatConstants.SuperiorLowLightVision,
            "",
            0,
            "",
