...
namespace CharacterGen.Tests.Integration.Tables.Abilities.Feats.Data.Racial.Metaraces
{
    ...
    public class VampireFeatDataTests : RacialFeatDataTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.Formattable.Collection.RACEFeatData, RaceConstants.Metaraces.Vampire);
            }
        }
        ...
        [TestCase(FeatConstants.ArmorBonus,
            ...
            "",
            6, 0, 0)]
        [TestCase(FeatConstants.Slam + RaceConstants.Sizes.Large,
            FeatConstants.Slam,
            "1d8",
            0,
            "",
            ...
            0, 0, 0)]
        [TestCase(FeatConstants.Slam + RaceConstants.Sizes.Medium,
            FeatConstants.Slam,
            "1d6",
            0,
            "",
            ...
            0, 0, 0)]
        [TestCase(FeatConstants.Slam + RaceConstants.Sizes.Small,
            FeatConstants.Slam,
            "1d4",
            0,
            "",
        ...
        [TestCase(FeatConstants.Dodge,
            ...
            0,
            "",
            1, 0, 13, StatConstants.Dexterity)]
