...
{
    [TestFixture]
    public class DexterityAbilityAdjustmentsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.ABILITYAbilityAdjustments, AbilityConstants.Dexterity); }
        }
        ...
        [TestCase(RaceConstants.BaseRaces.AquaticElf, 2)]
        ...
        [TestCase(RaceConstants.BaseRaces.DeathSlaad, 12)]
        ...
        [TestCase(RaceConstants.BaseRaces.Githzerai, 6)]
        ...
        public void DexterityAbilityAdjustment(string name, int adjustment)
        {
