...
{
    [TestFixture]
    public class CharismaAbilityAdjustmentsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.ABILITYAbilityAdjustments, AbilityConstants.Charisma); }
        }
        ...
        public void CharismaAbilityAdjustment(string name, int adjustment)
        {
