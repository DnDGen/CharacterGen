...
{
    [TestFixture]
    public class DivinationFeatDataTests : CharacterClassFeatDataTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Collection.CLASSFeatData, CharacterClassConstants.Schools.Divination); }
        }
        ...
        [TestCase(FeatConstants.SkillBonus,
            ...
            SkillConstants.Spellcraft + " (Learn Divination spells)",
            0,
            "",
            "",
            1,
