...
namespace CharacterGen.Tests.Integration.Tables.Feats.Data.CharacterClasses.Schools
{
    [TestFixture]
    public class TransmutationFeatDataTests : CharacterClassFeatDataTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Collection.CLASSFeatData, CharacterClassConstants.Schools.Transmutation); }
        }
        ...
        [TestCase(FeatConstants.SkillBonus,
            ...
            SkillConstants.Spellcraft + " (Learn Transmutation spells)",
            0,
            "",
            "",
            1,
