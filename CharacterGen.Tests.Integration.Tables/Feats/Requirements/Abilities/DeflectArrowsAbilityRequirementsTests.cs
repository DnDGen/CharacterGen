...
{
    [TestFixture]
    public class DeflectArrowsAbilityRequirementsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.FEATAbilityRequirements, FeatConstants.DeflectArrows); }
        }
