...
{
    [TestFixture]
    public class CombatExpertiseAbilityRequirementsTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.FEATAbilityRequirements, FeatConstants.CombatExpertise); }
        }
