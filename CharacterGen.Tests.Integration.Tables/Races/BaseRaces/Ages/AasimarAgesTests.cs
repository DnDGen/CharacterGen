...
{
    [TestFixture]
    public class AasimarAgesTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.RACEAges, RaceConstants.BaseRaces.Aasimar); }
        }
        ...
        [TestCase(RaceConstants.Ages.MiddleAge, 45)]
        [TestCase(RaceConstants.Ages.Old, 68)]
