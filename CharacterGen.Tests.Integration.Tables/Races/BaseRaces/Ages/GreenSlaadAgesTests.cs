...
{
    [TestFixture]
    public class GreenSlaadAgesTests : AdjustmentsTests
    {
        protected override string tableName
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.RACEAges, RaceConstants.BaseRaces.GreenSlaad); }
        }
        ...
        [TestCase(RaceConstants.Ages.Adulthood, 1)]
