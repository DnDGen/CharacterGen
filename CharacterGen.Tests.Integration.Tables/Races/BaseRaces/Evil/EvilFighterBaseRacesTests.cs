...
namespace CharacterGen.Tests.Integration.Tables.Races.BaseRaces.Evil
{
    ...
    public class EvilFighterBaseRacesTests : PercentileTests
    {
        ...
        [TestCase(59, 70, RaceConstants.BaseRaces.Hobgoblin)]
        [TestCase(71, 72, RaceConstants.BaseRaces.Githyanki)]
        [TestCase(73, 73, RaceConstants.BaseRaces.DeathSlaad)]
        [TestCase(74, 74, RaceConstants.BaseRaces.YuanTiHalfblood)]
        [TestCase(75, 75, RaceConstants.BaseRaces.YuanTiAbomination)]
        [TestCase(76, 77, RaceConstants.BaseRaces.Gargoyle)]
