...
namespace CharacterGen.Tests.Integration.Tables.Races.BaseRaces.Evil
{
    ...
    public class EvilRogueBaseRacesTests : PercentileTests
    {
        ...
        [TestCase(76, 81, RaceConstants.BaseRaces.Goblin)]
        [TestCase(82, 83, RaceConstants.BaseRaces.DeathSlaad)]
        [TestCase(84, 84, RaceConstants.BaseRaces.YuanTiPureblood)]
        [TestCase(85, 85, RaceConstants.BaseRaces.YuanTiHalfblood)]
        [TestCase(86, 86, RaceConstants.BaseRaces.YuanTiAbomination)]
        [TestCase(87, 87, RaceConstants.BaseRaces.Gargoyle)]
