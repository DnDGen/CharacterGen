...
namespace CharacterGen.Tests.Integration.Tables.Races.BaseRaces.Evil
{
    ...
    public class EvilClericBaseRacesTests : PercentileTests
    {
        ...
        [TestCase(80, 90, RaceConstants.BaseRaces.Troglodyte)]
        [TestCase(91, 91, RaceConstants.BaseRaces.Rakshasa)]
        [TestCase(92, 92, RaceConstants.BaseRaces.Harpy)]
        [TestCase(93, 93, RaceConstants.BaseRaces.CloudGiant)]
