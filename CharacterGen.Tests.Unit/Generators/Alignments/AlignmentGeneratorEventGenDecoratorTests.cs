...
namespace CharacterGen.Tests.Unit.Generators.Alignments
{
    ...
    public class AlignmentGeneratorEventGenDecoratorTests
    {
        ...
        public void LogEventsForAlignmentGeneration()
        {
            ...
            mockEventQueue.Verify(q => q.Enqueue("CharacterGen", $"Beginning alignment generation"), Times.Once);
            mockEventQueue.Verify(q => q.Enqueue("CharacterGen", $"Completed generation of lawfulness goodness"), Times.Once);
        }
    }
}
