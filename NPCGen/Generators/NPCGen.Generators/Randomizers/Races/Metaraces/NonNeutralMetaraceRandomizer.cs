...
namespace NPCGen.Generators.Randomizers.Races.Metaraces
{
    public class NonNeutralMetaraceRandomizer : BaseForcableMetarace
    {
        ...
        public NonNeutralMetaraceRandomizer(IPercentileSelector percentileResultSelector, IAdjustmentsSelector levelAdjustmentSelector, INameSelector nameSelector,
