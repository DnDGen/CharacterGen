...
namespace DnDGen.CharacterGen.Tests.Integration.Generators.Verifiers
{
    ...
    public class RandomizerVerifierTests : IntegrationTests
    {
        ...
        [TestCase(AlignmentRandomizerTypeConstants.Any, ClassNameRandomizerTypeConstants.AnyPlayer, LevelRandomizerTypeConstants.Any, "Set," + RaceConstants.BaseRaces.HillGiant, "Set," + RaceConstants.Metaraces.Wereboar, true)]
