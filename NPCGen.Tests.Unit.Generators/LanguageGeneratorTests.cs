...
namespace NPCGen.Tests.Unit.Generators
{
    ...
    public class LanguageGeneratorTests
    {
        ...
        private Mock<ILanguagesSelector> mockLanguageProvider;
        ...
        public void Setup()
        {
            ...
            mockLanguageProvider = new Mock<ILanguagesSelector>();
            languageFactory = new LanguageGenerator(mockDice.Object, mockLanguageProvider.Object);
