...
namespace CharacterGen.Tests.Integration.Generators.Verifiers
{
    [TestFixture]
    public class RandomizerVerifierTests : IntegrationTests
    {
        ...
        [TestCase(AlignmentRandomizerTypeConstants.Any, ClassNameRandomizerTypeConstants.AnyNPC, LevelRandomizerTypeConstants.Any, RaceRandomizerTypeConstants.BaseRace.MonsterBase, RaceRandomizerTypeConstants.Metarace.AnyMeta + ",,False", true)]
        ...
        [TestCase(AlignmentRandomizerTypeConstants.NonEvil, ClassNameRandomizerTypeConstants.AnyNPC, LevelRandomizerTypeConstants.Medium, RaceRandomizerTypeConstants.BaseRace.MonsterBase, RaceRandomizerTypeConstants.Metarace.LycanthropeMeta + ",,False", true)]
