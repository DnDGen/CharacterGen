    ...
    public static class LeadershipGeneratorFactory
    {
        public static ILeadershipGenerator Create(IKernel kernel)
        {
            ...
            return new LeadershipGenerator(characterGenerator, leadershipSelector, percentileSelector, adjustmentsSelector,
                setLevelRandomizer, setAlignmentRandomizer, anyAlignmentRandomizer, anyClassNameRandomizer, anyBaseRaceRandomizer, anyMetaraceRandomizer,
                rawStatsRandomizer, booleanPercentileSelector, collectionsSelector, alignmentGenerator, generator);
        }
    }
}
