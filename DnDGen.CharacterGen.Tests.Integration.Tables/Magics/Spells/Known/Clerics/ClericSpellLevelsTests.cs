...
namespace DnDGen.CharacterGen.Tests.Integration.Tables.Magics.Spells.Known.Clerics
{
    ...
    public class ClericSpellLevelsTests : AdjustmentsTests
    {
        ...
        [TestCase(SpellConstants.InflictMinorWounds, 0)]
        ...
        [TestCase(SpellConstants.InflictModerateWounds, 2)]
        ...
        [TestCase(SpellConstants.InflictSeriousWounds, 3)]
        ...
        [TestCase(SpellConstants.InflictModerateWounds_Mass, 6)]
        ...
        [TestCase(SpellConstants.CureSeriousWounds_Mass, 7)]
        [TestCase(SpellConstants.InflictSeriousWounds_Mass, 7)]
